...
const { hkdfExpandLabel, sha384, hmac384 } = require("./hkdf");

const key = Buffer.from("1135b4826a9a70257e5a391ad93093dfd7c4214812f493b3e3daae1eb2b1ac69", "hex");
const iv = Buffer.from("4256d2e0e88babdd05eb2f27", "hex");
...
function encrypt(iv, recordNum, key, recData, data) {
...
function testEncrypt() {
  const uncryptedData = Buffer.from("14000030bff56a671b6c659d0a7c5dd18428f58bdd38b184a3ce342d9fde95cbd5056f7da7918ee320eab7a93abd8f1c02454d2716", "hex");
  const recData = Buffer.from("1703030045", "hex");
  const [encryptedData, authTag] = encrypt(iv, 0, key, recData, uncryptedData);
  console.log("🚀 ~ file: encrypt.js:34 ~ encryptedData:", encryptedData);
  console.log("🚀 ~ file: encrypt.js:34 ~ authTag:", authTag);
}
...
function getHandShakeFinish(clientSecret) {
...
function testGetHandShakeFinish() {
  const verifyData = getHandShakeFinish(clientSecret);
  console.log("🚀 ~ file: encrypt.js:68 ~ verifyData:", verifyData.toString("hex"));
}
